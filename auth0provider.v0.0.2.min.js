...
var EventEmitter = /*#__PURE__*/function () {
  ...
  _createClass(EventEmitter, [{
    ...
    value: function on(event, fn) {
      var thisContext = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

      if (typeof fn != 'function') {
        return;
      }

      this._listeners[event] = this._listeners[event] || []; // @ts-ignore
    ...
    value: function off(event, fn) {
      ...
      var i = this._listeners[event].indexOf(fn);
    ...
    value: function emit(event, payload) {
      ...
      for (var i = 0; i < length; i++) {
        var fn = this._listeners[event][i];
...
var AuthPlugin = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(AuthPlugin, [{
    key: "loginWithPopup",
    value: function () {
      var _loginWithPopup = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
        var o,
            _args = arguments;
    ...
    value: function () {
      var _handleRedirectCallback = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
    ...
    value: function () {
      var _getIdentityClaims = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(token) {
    ...
    key: "getUserData",
    value: function () {
      var _getUserData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4() {
    ...
    key: "created",
    value: function () {
      var _created = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(options) {
