...
exports.onAuthLoaded = exports.authGuard = undefined;
...
var authGuard = exports.authGuard = function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(to, from, next) {
    var authService;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 6:
            return _context6.abrupt("return", instance.loginWithRedirect({ returnTo: to.fullPath }));
  ...
  return function authGuard(_x7, _x8, _x9) {
...
var _auth0SpaJs2 = _interopRequireDefault(_auth0SpaJs);
...
var AuthPlugin = function (_EventEmitter) {
  ...
  function AuthPlugin() {
    ...
    var _this = _possibleConstructorReturn(this, (AuthPlugin.__proto__ || Object.getPrototypeOf(AuthPlugin)).call(this));
  ...
  _createClass(AuthPlugin, [{
    ...
    value: function () {
      ...
      function getIdentityClaims(_x4) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 7:
                ...
                _context4.next = 11;
                return fetch("https://" + this.options.domain + "/userinfo", {
                  headers: {
...
};var onAuthLoaded = exports.onAuthLoaded = function onAuthLoaded(cb) {
