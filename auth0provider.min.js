...
exports.onAuthLoaded = undefined;
...
class AuthPlugin extends _EventEmitter.EventEmitter {
  constructor(options = {}) {
    if (instance) {
      return instance;
    }
  ...
  async created(options) {
    ...
    this.auth0Client = await (0, _auth0SpaJs2.default)({
 ...
 * @param {function} [cb]
 */
const onAuthLoaded = exports.onAuthLoaded = cb => {
